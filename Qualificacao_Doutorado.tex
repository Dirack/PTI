...
\titulo{ADMINISTRAÇÃO CIENTÍFICA, CLÁSSICA E HUMANÍSTICA}

\autor{Rodolfo André Cardoso Neves}
\local{Belém-Pará}
\data{2021}

\orientador{Prof(a). Silmara Cristiane Gomes}
\coorientador{}
...
Serviço Nacional de Aprendizagem Comercial (SENAC), em cumprimento às exigências da disciplina Fundamentos da Administração.}
...
\begin{capa}
	...
	\end{figure}
			\begin{center}
				{\ABNTEXchapterfont\bfseries{SERVIÇO NACIONAL DE APRENDIZAGEM COMERCIAL - SENAC \\ TECNOLOGIA EM ANÁLISE E DESENVOLVIMENTO DE SISTEMAS \\ FUNDAMENTOS DA ADMINISTRAÇÃO} }
		\end{center}
...
\begin{center}
	...
	\SingleSpacing
	\imprimirpreambulo\\ \\
	{Professora: Silmara Cristiane Gomes.}\\
	\end{minipage}
	\vspace*{\fill}
	}
