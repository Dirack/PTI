...
\titulo{PESQUISA SOBRE: O USO DE ADOÇANTES POR CRIANÇAS E ADULTOS}

\autor{Rodolfo André Cardoso Neves}
\local{Belém-Pará}
\data{2021}

\orientador{Prof. Renato Almada Alonso}
\coorientador{}
...
Serviço Nacional de Aprendizagem Comercial (SENAC), em cumprimento às exigências da disciplina Pesquisa, Tecnologia e Sociedade.}
...
\begin{capa}
	...
	\end{figure}
			\begin{center}
				{\ABNTEXchapterfont\bfseries{SERVIÇO NACIONAL DE APRENDIZAGEM COMERCIAL - SENAC \\ TECNOLOGIA EM ANÁLISE E DESENVOLVIMENTO DE SISTEMAS \\ PESQUISA, TECNOLOGIA E SOCIEDADE} }
		\end{center}
...
\begin{center}
	...
	\SingleSpacing
	\imprimirpreambulo\\ \\
	{Professor: Renato Almada Alonso.}\\
	\end{minipage}
	\vspace*{\fill}
	}
